...
By accessing or using the Services, you ("**Customer**", "**you**", or "**your**") agree to be bound by these Terms and our [Privacy Policy](/privacy/). If you are accepting these Terms on behalf of a company or other legal entity, you represent that you have the authority to bind that entity. If you do not agree to these Terms, you must not access or use the Services.
...
**"Documentation"** means the technical and user documentation made available by Spectra Analytics at [spectra-analytics.com/docs](https://spectra-analytics.com/docs/).
...
- Copy, modify, translate, adapt, or create derivative works of the Services or Platform
- Reverse engineer, decompile, disassemble, or attempt to derive source code from the Services
- Sublicense, sell, resell, transfer, assign, or otherwise commercially exploit the Services to any third party
- Use the Services to develop a competing product or service
- Access the Services by any automated means (e.g. bots, scrapers) without prior written consent
- Use the Services to process data in violation of any applicable law, including data protection legislation
...
- Ensuring it has all rights, consents, and permissions necessary to upload and process Customer Data through the Services
- Ensuring Customer Data does not infringe any third-party rights or violate applicable law
...
### 5.1 Spectra Analytics Ownership
...
### 7.1 Spectra Analytics Warranties
...
### 12.8 Notices
All legal notices under these Terms shall be in writing and sent to Spectra Analytics at [info@spectra-analytics.com](mailto:info@spectra-analytics.com) or to Customer at the email address associated with its account.
